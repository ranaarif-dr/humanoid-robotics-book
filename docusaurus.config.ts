...
const config = {
  ...
  url: 'https://ranaarif-dr.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  baseUrl: '/humanoid-robotics-book',

  // GitHub pages deployment config.
  organizationName: 'ranaarif-dr', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/ranaarif-dr/humanoid-robotics-book/tree/main",
